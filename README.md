...
- Se observo que la radio cuenta con telemetria que se conecta a servidores de china en los cuales informa la posicion gps, velocidad y posicion de la palanca de cambios. Se aconseja no conectarlo a una red wifi para evitar el envio de estos datos.
